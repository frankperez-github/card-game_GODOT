...
namespace gameEngine
{
    public class inventory
    {
        ...
        public inventory()
        {
            ...
            {
                new CharacterProperties(1001, "El dragón indiferente", 0, 2, "res://Sprites/Cards-images/DALL·E 2022-10-10 15.21.44 - The lost dragon of Argea sleeping over a city digital art.png", "(Enemy.ChangeState.Asleep)", "Intimida al oponente dando golpes en el pecho y lo hace perder 2 turnos", 10, 3),
                ...
                new CharacterProperties(1003, "La serpiente truhana", 0, 2, "res://Sprites/Cards-images/DALL·E 2022-10-23 15.35.44 - medieval style snake in a nuclear war digital art.png", "(Enemy.ChangeState.Poisoned)", "No hay nada mas tóxico que ella (ni siquiera tu ex) Empieza un envenenamiento que le quita 10 de vida al enemigo en cada turno", 5, 0),
                new CharacterProperties(1004, "El tigre recursivo", 2, 3, "res://Sprites/Cards-images/DALL·E 2022-10-23 15.49.37 - Hercules' tiger in a nuclear war digital art.png", "(Owner.Draw.Deck.1)", "Cada 2 turnos puedes robar una carta extra del deck, este efecto se activa solo 3 veces", 8, 0),
