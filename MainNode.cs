...
namespace card_gameEngine
{
    ...
    public class MainNode : Node
    {
        ...
        public static PackedScene mainMenuScene = (PackedScene)GD.Load("res://mainMenu.tscn");
        board board = new board();
        // Called when the node enters the scene tree for the first time.
        public override void _Ready()
        {
            // Showing Main menu first
            AddChild(mainMenuScene.Instance());
        ...
        public override void _Process(float delta)
        {
            ...
            Player player1 = MainNode.PlayersInventary[0];
            Player player2 = MainNode.PlayersInventary[1];
            ...
            PlayerNick.Text = MainNode.PlayersInventary[0].nick;
            Label PlayerLife = GetNode<Label>("PlayerInfo/Player's Life");
            PlayerLife.Text = "Life : "+ MainNode.PlayersInventary[0].life.ToString();
            Label PlayerShield = GetNode<Label>("PlayerInfo/Player's Shield");
            PlayerShield.Text = "Shield : "+ MainNode.PlayersInventary[0].defense.ToString();
            Label PlayerAttack = GetNode<Label>("PlayerInfo/Player's Attack");
            PlayerAttack.Text = "Attack : "+ MainNode.PlayersInventary[0].attack.ToString();

            Label Player2Nick = GetNode<Label>("Player2Info/Player2's Nick");
            Player2Nick.Text = MainNode.PlayersInventary[1].nick;
            Label Player2Life = GetNode<Label>("Player2Info/Player2's Life");
            Player2Life.Text = "Life : "+ MainNode.PlayersInventary[1].life.ToString();
            Label Player2Shield = GetNode<Label>("Player2Info/Player2's Shield");
            Player2Shield.Text = "Shield : "+ MainNode.PlayersInventary[1].defense.ToString();
            Label Player2Attack = GetNode<Label>("Player2Info/Player2's Attack");
            Player2Attack.Text = "Attack : "+ MainNode.PlayersInventary[1].attack.ToString();
            #endregion
